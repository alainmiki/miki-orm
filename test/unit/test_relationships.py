...
from mikiorm.models.relationships import CASCADE, SET_NULL, SET_DEFAULT, PROTECT, DO_NOTHING
...
class SetDefaultChild(Model):
    name = CharField(max_length=50)
    parent = ForeignKey(SetDefaultParent, on_delete=SET_DEFAULT, null=True, related_name="items", default="default_val")
...
from mikiorm.models.fields import AutoField  # noqa: E402
